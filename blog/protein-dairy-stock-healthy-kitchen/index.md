...
# The animals diet and the effects on its meat
...
Pasteurization is ["the process of heat processing a liquid or a food to kill pathogenic bacteria to make the food respectively the drink safe to eat."](http://www.foodsafetysite.com/educators/competencies/general/foodprocessing/processing2.html) That means that milk is heated up to a specific temperature, mostly around 145 °F or 161 °F, for a set period of time. Times and temperature vary depending on the type of food and the result aimed to achieve, e.g. retaining a food’s nutrients, texture, color and flavor.
...
# Poultry as part of a healthy kitchen
...
# Stocking a healthy kitchen: Seafood
