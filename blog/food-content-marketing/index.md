...
At the heart of every good story are emotions and the story of the two founders of Your Superfoods is full of it. Emotions have a huge impact on what we buy. In fact, [our buying decision are 80 percent emotional and only in 20 percent based on logic](https://blog.thesocialms.com/power-emotions-in-content-marketing-reactions/). When we’re evaluating brands, we’re primarily using emotions rather than facts and information. Thus, triggering a particular emotion can help you win over a new customer and savvy marketers know how to do that.
...
These e-books also substantiate Your Superfoods’ authority in the field of supplements as experts much more than a blog post allows. Furthermore, their vast popularity and perceived high value have made them very popular among (small) business owners. Neil Patel, digital Marketing expert, even lists [eBooks as the second best strategy to create leads with content](https://neilpatel.com/blog/beginners-guide-to-content-based-lead-generation/).
...
Your Superfood has also dedicated a whole page to their charity efforts. They know that millennials care about causes. In fact, [they are more likely to buy from a company with purpose than members of other generations](https://www.bcg.com/documents/file103894.pdf). Thus, this target group is very receptive to cause word of mouth.
...
And yes, consumers are hungry for food content. Or how else would you explain the explosion of #foodporn on social platforms such as Instagram? Especially among millenials, who are the biggest digital content consumers, [gravitate towards healthy, natural foods and like to cook and prepare their meals themselves](https://www.prnewswire.com/news-releases/new-research-proves-millennials-are-upsetting-the-grocery-cart-with-their-focus-on-fresh-fitness-and-flavor-300526046.html).

Furthermore, according to a study by Nielsen, [millennials are eager to know more about how their food is produced and want to "see the story behind the scenes"](https://www.nielsen.com/us/en/insights/news/2016/keys-to-unlocking-the-millennial-mindset.html) (81 and 80 percent, respectively). 73 percent is even willing to pay more for sustainable brands.
...
Most popular in Food Marketing is content like [recipes and how-tos that "inform" (40%) and "educate" (28%)](https://pages.onespot.com/State-of-Food-Content-Marketing-Report-LP.html). The focus should be on high-quality content, especially videos that are visually interesting and focus on the persons individual needs and interests.

## Live Video about Cooking and Behind the Scenes

Video is huge. More than 30 million users daily consume [five billion videos](https://merchdope.com/vlogging-camera/) a day on YouTube alone, according to recent studies. Platforms like Facebook, Instagram or Twitter are investing heavily in the medium. These days, [live videos particularly are on the rise](https://livestream.com/blog/62-must-know-stats-live-video-streaming), being even more interesting to consumers than reading a blog from the same brand.

![food content marketing live video](./images/live_video.jpg)

In food marketing, live videos can be especially powerful. After all, it’s hard to resist a temptation when it’s shown visually. You might share your test kitchen with your viewers, just like [Dunkin Donuts](https://www.forbes.com/sites/jaysondemers/2016/11/23/5-awesome-examples-of-brands-using-live-video-for-marketing/#4819eda9bcdd) did or show how you create miniature versions of food like Tastemade did.
...
With these chatbots you can now [get customised dinner recipes](https://chatbotslife.com/the-five-food-and-restaurant-ai-chatbots-you-should-know-about-393c870b0ca5?gi=e5fbf4f0694), [instant wine recommendations when tweeting recipe links](https://www.delipair.com/), or [browse products and recipes by sending emojis or keywords](https://venturebeat.com/2016/07/12/whole-foods-just-launched-a-messenger-chatbot-for-finding-recipes-with-emojis/) - and these are just a few ideas. What about a Facebook messenger bot which recommends recipes for ingredients you have available at home?
